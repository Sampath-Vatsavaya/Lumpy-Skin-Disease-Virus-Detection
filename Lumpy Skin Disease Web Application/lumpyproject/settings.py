"""
Django settings for lumpyproject project.
...
SECRET_KEY = 'django-insecure-l75@y@$ng9(jnt(p35e#i(ecy^0t&b09@42xpezs6aja8c6sm('
...
WSGI_APPLICATION = 'lumpyproject.wsgi.application'
